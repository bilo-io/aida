...
export const sections = (
...
): ISection[] => [
  {
    ...
    description: '',
    // description: t?.landing.sections[0]?.description as string,
    ...
    items: [
      {
        text: (
          <View className="flex flex-col items-center justify-center">
            <View>{'Operating in 7+ languages across the globe'}</View>
            <View className="-ml-48 mt-8">
              <LanguageFlags />
            </View>
          </View>
        )
      ...
      },
      {
        text: (
          <View>
            <View>{'Secured with trusted SSO providers'}</View>
            <View className="ml-16 mt-8">
              <SSOLogos />
            </View>
          </View>
        )
    ...
    items: [
      {
        ...
        image: themeName === 'dark' ? imgPlaceholder : imgPlaceholder,
