import { Button, Input, Typography, View } from 'components/Core';
...
export const LandingEarlyAccess: React.FC = () => {
  ...
  return (
    <RandomBackground hasBlur>
      <Section isCentered>
        <View className="min-h-80 flex flex-col items-center justify-center px-2 py-20">
        ...
        <View className="card card-1 flex flex-col items-center justify-center mb-0 w-fit mx-auto rounded-lg"
          style={{
